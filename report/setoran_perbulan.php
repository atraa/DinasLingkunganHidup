...
<html>
    <head>
        <title>Cetak Data Setoran Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                       <h2>Sistem Informasi<br>Dinas Lingkungan Hidup<br>Tanjungbalai </h2>
                        <h4>Jl. Gaharu No.14 Sirantau, Datuk Bandar, Kota Tanjung Balai, Sumatera Utara 21332, Indonesia</h4>
                        <hr> 
                        <h3>DATA SETORAN BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                    ...
                    <th>Staff Penerima Setoran</th>
                            ...
                            $sql = "SELECT * FROM tbl_setoran WHERE substr(tgl_setor,1,7)='$ambilthn-$ambilbln'";
